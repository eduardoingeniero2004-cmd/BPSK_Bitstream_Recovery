...
# Title: Modulation_BPSK
# Author: Ing. Eduardo Alberto Bañales Ramirez
# Description: Digital Modulation BPSK
...
class Modulation_BPSK(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulation_BPSK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulation_BPSK")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Modulation_BPSK")
        ...
        self.qtgui_tab_widget_0_layout_4.addWidget(self._qtgui_time_sink_x_1_0_win)
        ...
        self.qtgui_tab_widget_0_layout_1.addWidget(self._qtgui_time_sink_x_1_win)
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_f(
            512, #size
            samp_rate, #samp_rate
            'Mensaje  casi recuperado', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_tab_widget_0_layout_2.addWidget(self._qtgui_time_sink_x_0_0_win)
        ...
        self.qtgui_tab_widget_0_layout_3.addWidget(self._qtgui_time_sink_x_0_win)
        ...
        self.qtgui_tab_widget_0_layout_0.addWidget(self._qtgui_const_sink_x_0_win)
        ...
        self.blocks_keep_m_in_n_0 = blocks.keep_m_in_n(gr.sizeof_gr_complex, 1, 8, 3)
        ...
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 32)
        ...
        self.connect((self.blocks_char_to_float_0_0_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        ...
        self.connect((self.blocks_keep_m_in_n_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_keep_m_in_n_0, 0), (self.qtgui_const_sink_x_0, 0))
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_char_to_float_0_0_0, 0))
        ...
        self.connect((self.digital_costas_loop_cc_0, 0), (self.blocks_keep_m_in_n_0, 0))
...
def main(top_block_cls=Modulation_BPSK, options=None):
